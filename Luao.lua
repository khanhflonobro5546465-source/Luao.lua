...
BackgroundTransparency=0.35 -- XUYÊN QUA
}
}
...
E("UIStroke",{Color=Color3.fromRGB(45,45,45),Thickness=1,Transparency=0.3}).Parent=searchFrame
...
-- =====================================================================
-- COMPAT LAYER cho VarHub (giu nguyen ten goi: Window / NewPage /
...
local function __cfg(v)
return type(v) == "table" and v or {}
end

-- Element aliases
ai.SetDesc = ai.SetDescription
ai.SetText = ai.SetText or ai.SetDescription
ai.SetName = ai.SetTitle

-- Tab: Section dung code cua AddParagraph
function ah:Section(a, b)
return self:AddParagraph(type(a) == "table" and (a[1] or a.Title or a.Name or "") or tostring(a or ""), type(a) == "table" and (a.Desc or a.Description) or b)
end

function ah:Paragraph(a)
a = __cfg(a)
return self:AddParagraph(a[1] or a.Title or a.Name or "", a.Desc or a.Description)
end

function ah:Toggle(a)
a = __cfg(a)
return self:AddToggle({
Title = a[1] or a.Title or a.Name or "Toggle",
Desc = a.Desc or a.Description,
Default = (a.Default ~= nil and a.Default or a.Value or a.State) and true or false,
Callback = a.Callback,
Flag = a.Flag
})
end

function ah:Button(a)
a = __cfg(a)
return self:AddButton({
Title = a[1] or a.Title or a.Name or "Button",
Desc = a.Desc or a.Description,
Callback = a.Callback,
Debounce = a.Debounce or a.Cooldown
})
end

function ah:Input(a)
a = __cfg(a)
local placeholder = a.Placeholder or a.PlaceholderText or a.Value or a.Default
return self:AddTextBox({
Title = a[1] or a.Title or a.Name or (type(placeholder) == "string" and placeholder) or "Input",
Desc = a.Desc or a.Description,
Default = type(a.Default) == "string" and a.Default or nil,
Placeholder = type(placeholder) == "string" and placeholder or nil,
ClearOnFocus = a.ClearOnFocus or a.ClearTextOnFocus,
Callback = a.Callback,
Flag = a.Flag
})
end
...
function ah:Slider(a)
a = __cfg(a)
return self:AddSlider({
Title = a[1] or a.Title or a.Name or "Slider",
Desc = a.Desc or a.Description,
Min = a.Min or 0,
Max = a.Max or 100,
Increment = a.Increment or a.Step or a.Rounding or 1,
Default = a.Default or a.Value,
Callback = a.Callback,
Flag = a.Flag
})
end

function ah:Dropdown(a)
a = __cfg(a)
local element = self:AddDropdown({
Title = a[1] or a.Title or a.Name or "Dropdown",
Desc = a.Desc or a.Description,
Options = a.Options or a.List or a.Values or {},
Default = a.Default or a.Value,
MultiSelect = a.MultiSelect or a.Multi,
Callback = a.Callback,
Flag = a.Flag
})

-- Refresh(list, keepValue) cua VarHub
function element:Refresh(list, keep)
local current = self.Value
self:Clear()
if type(list) == "table" then
self:NewOptions(table.unpack(list))
end
if keep and current ~= nil and self.SetValue then
pcall(function() self:SetValue(current) end)
end
return self
end
...
-- Window / Library aliases
local __window

function ag:NewPage(a)
a = __cfg(a)
return self:MakeTab({
Title = a[1] or a.Title or a.Name or "Tab",
Icon = __asIcon(a.Icon or a.Image)
})
end
ag.NewTab = ag.NewPage
ag.Tab = ag.NewPage

function s:Window(a)
a = __cfg(a)
__window = self:MakeWindow({
Title = a[1] or a.Title or a.Name or "Window",
SubTitle = a.SubTitle or a.SubName or a.Desc or "",
ScriptFolder = a.ScriptFolder or a.FolderName
})
return __window
end
s.CreateWindow = s.Window

function s:Notify(a)
a = __cfg(a)
local cfg = {
Title = a[1] or a.Title or a.Name or "Notify",
Content = a.Content or a.Message or a.Text or a.Desc or "",
Icon = __asIcon(a.Icon or a.Image),
Duration = a.Duration or a.Time or a.Countdown
}
if __window then
return __window:Notify(cfg)
end
end
